...
<!-- Mirrored from htmldemo.net/subas/subas/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Apr 2023 16:27:23 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!-- Favicon -->
    @include('shareHeader.headercssLinker')
</head>
...
<body>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="wishlist">
                                    <div class="wishlist-content">
                                        <form action="#">
                                            <div class="table-content table-responsive mb-50" id="change-wishlist-item" >
                                                @include('shareContent.wishlistDetail')
                                            </div>
                                        </form>
                                    </div>
                                </div>
    ...
    @include('shareHeader.footerJsLinker')

</body>


<!-- Mirrored from htmldemo.net/subas/subas/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Apr 2023 16:27:24 GMT -->
</html>
