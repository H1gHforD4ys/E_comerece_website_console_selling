...
<!-- Mirrored from htmldemo.net/subas/subas/shop-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Apr 2023 16:27:31 GMT -->
                            ...
                            <div class="shop-content">
                                ...
                                <div class="shop-option box-shadow mb-30 clearfix">
                                    ...
                                    <ul class="nav shop-tab f-left" role="tablist">
                                        <li>
                                            <a href="#grid-view" data-bs-toggle="tab"><i
                                                    class="zmdi zmdi-view-module"></i></a>
                                        </li>
                                        <li>
                                            <a class="active" href="#list-view" data-bs-toggle="tab"><i
