            ...
            <div class="slider-content">
                <div class="active-slider-1 slick-arrow-1 slick-dots-1">
                    ...
                    <div class="col-lg-12">
                        <div class="layer-1">
                            <div class="slider-img">
                                <img src="img/slider/slider-1/swoled.jpg" style="width:800px;height:600px;" alt="">
                            </div>
                            <div class="slider-info gray-bg">
                                <div class="slider-info-inner">
                                    <h1 class="slider-title-1 text-uppercase text-black-1">switch oled</h1>
                                    ...
                                    <a href="{{ url('/Single-Product/6') }}" class="button extra-small button-black">
                    ...
                    <div class="col-lg-12">
                        <div class="layer-1">
                            <div class="slider-img">
                                <img src="img/slider/slider-1/playstation5.jpg" style="width:800px;height:600px;" alt="">
                            </div>
                            <div class="slider-info gray-bg">
                                <div class="slider-info-inner">
                                    <h1 class="slider-title-1 text-uppercase text-black-1">playstation V</h1>
                                    <div class="slider-brief text-black-2">
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority
                                            have suffered alteration in some form, by injected humour, or randomised words
                                            which don't look even slightly believable. If you are going to use a passage of
                                    ...
                                    <a href="{{ url('/Single-Product/255') }}" class="button extra-small button-black">
                                        <span class="text-uppercase">Buy now</span>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="layer-1">
                            <div class="slider-img">
                                <img src="img/slider/slider-1/steamdeck.jpg" style="width:800px;height:600px;" alt="">
                            </div>
                            <div class="slider-info gray-bg">
                                <div class="slider-info-inner">
                                    <h1 class="slider-title-1 text-uppercase text-black-1">steam deck</h1>
                                    <div class="slider-brief text-black-2">
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority
                                            have suffered alteration in some form, by injected humour, or randomised words
                                            which don't look even slightly believable. If you are going to use a passage of
                            ...
                            <div class="active-by-brand slick-arrow-2">
                                ...
                                <div class="brand-item">
                                    <div class="single-brand-product">
                                        <a href="#"><img src="img/product/swoled.jpg" class="new-product"  alt=""></a>
                                        <h3 class="brand-title text-gray">
                                            <a href="#">Nintendo Switch Oled</a>
                                        </h3>
                                    </div>
                                </div>
                                ...
                                <div class="brand-item">
                                    <div class="single-brand-product">
                                        <a href="#"><img src="img/product/steamdeck.jpg" class="new-product"  alt=""></a>
                                        <h3 class="brand-title text-gray">
                                            <a href="#">Steam Deck</a>
                                        </h3>
                                    </div>
                                ...
                                <div class="brand-item">
                                    <div class="single-brand-product">
                                        <a href="#"><img src="img/product/swneon.jpg" class="new-product"  alt=""></a>
                                        <h3 class="brand-title text-gray">
                                            <a href="#">Nintendo Switch Neon</a>
                                        </h3>
                                    </div>
                                </div>
                                <!-- single-brand-product end -->
                                ...
                                <div class="brand-item">
                                    <div class="single-brand-product">
                                        <a href="#"><img src="img/product/swhunter.jpg" class="new-product" alt=""></a>
                                        <h3 class="brand-title text-gray">
                                            <a href="#">Nintendo Switch Hunter</a>
                                        </h3>
                                    </div>
                                </div>
                                <!-- single-brand-product end -->
                                ...
                                <div class="brand-item">
                                    <div class="single-brand-product">
                                        <a href="#"><img src="img/product/sw2.jpg" class="new-product" alt=""></a>
                                        <h3 class="brand-title text-gray">
                                            <a href="#">Nintendo Switch V2</a>
                                        </h3>
                                    </div>
                                </div>
                                <!-- single-brand-product end -->
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="featured-product">
                            <div class="active-featured-product slick-arrow-2">
                                @include('shareContent.hotProductList')
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8">
                        <div class="up-comming-pro gray-bg clearfix">
                            <div class="up-comming-pro-img f-left">
                                <a href="#">
                                    <img src="img/up-comming/zeldatotk.jpg" style="width:362px, height:350px" alt="">
                                </a>
                            </div>
                    ...
                    <div class="col-lg-4 d-block d-md-none d-lg-block">
                        <div class="banner-item banner-1">
                            ...
                            <div class="banner-img">
                                <a href="#"><img src="img/up-comming/zero2.jpg" style="width:370px, height:350px" alt=""></a>
                            </div>
                            <div class="banner-info">
                                <h3><a href="#">Zero 2</a></h3>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="product-tab pro-tab-menu text-end">
                            <!-- Nav tabs -->
                            <ul class="nav">
                                <li><a class="active" href="#this-week" data-bs-toggle="tab">Tuần này</a></li>
                                <li><a href="#this-month" data-bs-toggle="tab">Tháng này</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="this-week" class="tab-pane active show">
                                <div class="row">
                                    <!-- product-item start -->
                                    @include('shareContent.hotThisWeekList')
                                    <!-- product-item end -->
                                </div>
                            </div>
                            <!-- popular-product end -->
